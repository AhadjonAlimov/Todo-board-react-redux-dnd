...
function Footer(props) {
    return (
        <div>
            <footer className="text-center text-white" style={{ backgroundColor: "#30AADD" }}>
                <div className="pt-9 w-full">
                    <div className="flex justify-center mb-9">
                        ...
                        <a href="https://github.com/AhadjonAlimov" className="text-white">
                            <svg
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="fab"
                ...
                <div className="text-center text-white p-4">
                    ...
                    <a className="text-white" href="https://t.me/AAlimov_dev">Akhadjon Alimov</a>
                </div>
            </footer>
        </div>
    );
